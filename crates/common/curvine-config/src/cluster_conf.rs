...
impl ClusterConf {
    ...
    /// validate → resolve_master_addrs`. See [`crate::pipeline`].
...
mod tests {
    ...
    // re-implementation of its stages) must resolve every role hostname from
    // net_interface and ignore the hostname env allowlist.
    #[test]
