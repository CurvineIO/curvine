...
impl TtlCleanupResult {
    ...
    pub fn record_success(&mut self, count: u64) {
        self.successful_cleanups += count;
        self.total_processed += count;
    }
    pub fn record_failure(&mut self, count: u64) {
        self.failed_cleanups += count;
        self.total_processed += count;
    }
    pub fn total_processed(&self) -> u64 {
        self.total_processed
    }
    pub fn record_skip(&mut self, count: u64) {
        self.skipped_inodes += count;
        self.total_processed += count;
    }
    pub fn record_bucket(&mut self) {
        self.processed_buckets += 1;
    }
}
