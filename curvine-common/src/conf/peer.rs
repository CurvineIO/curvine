...
/// Node ID type used for raft peer identification
pub type NodeId = u64;

/// Represents a raft peer address configuration.
/// This is placed in conf module to avoid circular dependencies with raft module.
