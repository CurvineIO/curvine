...
fn test_mount_write_cache() {
    ...
    if env::var("UFS_TEST_PATH").is_err() {
        ...
        println!("   Example: export UFS_TEST_PATH=hdfs://192.168.108.129:9000");
        println!("   Example: export UFS_TEST_PROPERTIES=\"hdfs.namenode=hdfs://192.168.108.129:9000,hdfs.user=root\"");
        return;
    }
