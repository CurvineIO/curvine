...
ACTIONS:
    start       Start the curvine-object S3 gateway service
    stop        Stop the curvine-object S3 gateway service
    status      Show the status of the curvine-object service
    restart     Restart the curvine-object S3 gateway service
